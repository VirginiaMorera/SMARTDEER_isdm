...
knitr::opts_knit$set(root.dir = "C:/Users/Virginia/Dropbox/Virginia_post_UB/IDM")
setwd("C:/Users/Virginia/Dropbox/Virginia_post_UB/IDM")
...
boundary_sp <- boundary %>% 
  st_transform(st_crs("+proj=tmerc +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=km +no_defs")) %>% 
  as_Spatial()
